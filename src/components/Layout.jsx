...
import { LayoutDashboard, Users, Briefcase, Coffee, GraduationCap, Calendar, Wallet, MapPin, Menu, X, ChevronDown, FileText, Layers, Store } from 'lucide-react';
...
const standaloneItems = [
  ...
  { path: '/shop', label: 'فروشگاه', icon: Store },
