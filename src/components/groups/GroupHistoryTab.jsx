    ...
    <div className="space-y-4">
      <div className="bg-white rounded-xl border border-border p-4 space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <select value={groupFilter} onChange={e => setGroupFilter(e.target.value)} className="px-3 py-1.5 rounded-lg border border-input bg-background text-sm">
          ...
          <div className="relative flex-1 min-w-[140px]">
            ...
            <input type="text" placeholder="جستجوی نام / تلفن / گروه..." value={search} onChange={e => setSearch(e.target.value)} className="pr-9 pl-3 py-1.5 rounded-lg border border-input bg-background text-sm w-full" />
          </div>
