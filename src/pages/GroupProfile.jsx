              ...
              {monthPurchases.length === 0 ? (
                ...
                <div className="divide-y divide-border">
                  {monthPurchases.map(p => (
                    <div key={p.id} onClick={() => navigate(`/accounting/group/${p.id}`, { state: { from: location.pathname } })} className="py-2.5 flex items-center justify-between text-sm cursor-pointer hover:bg-muted/30">
